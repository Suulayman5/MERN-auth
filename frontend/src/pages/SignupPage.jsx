...
import PasswordStrengthMeter from '../components/PasswordStregth'
...
const SignupPage = () => {
  ...
  const handleSignup = async(e)=>{
    ...
    try {
      ...
      setIsLoading(false);  // Stop loading state after the request finishes
    }
  }
  return (
    <motion.div 
